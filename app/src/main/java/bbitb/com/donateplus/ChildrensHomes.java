    ...
    public static ArrayList<ChildrensHomes> getChildrensHomesFromFile(String filename, Context context){
        ...
        try {
            ...
            for(int i = 0; i < home.length(); i++){
                ...
                hom.email = home.getJSONObject(i).getString("email");
                hom.phone = home.getJSONObject(i).getString("phone");
                hom.longitude = home.getJSONObject(i).getDouble("longitude");
                hom.latitude = home.getJSONObject(i).getDouble("latitude");
